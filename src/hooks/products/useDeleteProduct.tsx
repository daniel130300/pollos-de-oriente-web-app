...
const useDeleteProduct = () => {
  ...
  const { mutateAsync: mutateDeleteFile, isLoading: deleteImageIsLoading } =
    useDeleteFile();
  ...
  const { isPending, mutate } = useMutation({
    ...
    onSuccess: () => {
      ...
      handleClose();
      enqueueSnackbar(productSnackbarMessages.success.delete, {
        variant: 'success',
      });
    },
    onError: () => {
      enqueueSnackbar(productSnackbarMessages.errors.delete, {
        variant: 'error',
      });
    },
  });
